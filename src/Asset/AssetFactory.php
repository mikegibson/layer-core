...
class AssetFactory extends \Assetic\Factory\AssetFactory {
	...
	protected function parseInput($input, array $options = array()) {
		if($input instanceof AssetInterface) {
			return $input;
		}
		...
		foreach ($this->getPaths($namespace) as $path) {
	 ...
	 */
	protected function applyWorkers(AssetCollectionInterface $asset) {
	 ...
	 */
	protected static function findRootDir($path, array $roots) {
