...
class NumberHelper {
	 ...
	 * @var string
	 */
	protected $_defaultCurrency = 'GBP';
	 ...
	 */
	public function precision($value, $precision = 3) {
	 ...
	 */
	public function fromReadableSize($size, $default = false) {
	 ...
	 */
	public function toPercentage($value, $precision = 2, $options = array()) {
	 ...
	 */
	public function format($value, $options = false) {
	 ...
	 */
	public function formatDelta($value, $options = array()) {
	 ...
	 */
	public function currency($value, $currency = null, $options = array()) {
